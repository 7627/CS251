...
$db = new SQLite3('/home/yamit/Desktop/mysqlitedb.db');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // $insres = $db->exec($qstr);
  // $qry=db->prepare("INSERT INTO records(name,email,website,gender) VALUES(?,?,?);");
  // $qry->execute(array($name,$email,$website,$gender));
  echo "<p>$name</p>";
}
